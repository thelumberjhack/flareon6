...
namespace BMPHIDE {
	...
	internal class Program
	{
		...
		public static byte[] extract_data(Bitmap bm) {
			int idx = 0;
			byte[] array = new byte[bm.Width*bm.Height];
			for (int i = 0; i < bm.Width; i++) {
				for (int j = 0; j < bm.Height; j++) {
					Color pixel = bm.GetPixel(i, j);
					byte red = (byte)(pixel.R & 7);
					byte green = (byte)((pixel.G & 7) << 3);
					byte blue = (byte)((pixel.B & 3) << 6);
					array[idx] = (byte)(red | green | blue);
					idx += 1;
				}
			}
			return array;
		...
		public static byte _h(byte data, int num) {
			int num3 = g(num);
			num++;
			int num4 = data;
			num4 = e((byte)num4, (byte)num3);
		...
		private static void Main(string[] args)
		{
			...
			// Console.WriteLine(string.Format("j: {0}", Program.j(103)));
			// Console.WriteLine(string.Format("j: {0}", Program.j(231)));
			// Console.WriteLine(string.Format("j: {0}", Program.j(27)));
			// Console.WriteLine(string.Format("j: {0}", Program.j(25)));
			// Console.WriteLine(string.Format("j: {0}", Program.j(228)));
			// Console.WriteLine(string.Format("j: {0}", Program.j(230)));
			// Console.WriteLine(string.Format("j: {0}", Program.j(100)));
